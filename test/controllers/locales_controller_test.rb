...
class LocalesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create locale" do
    assert_difference('Locale.count') do
      post locales_url, params: { locale: { address: @locale.address, latitude: @locale.latitude, longitude: @locale.longitude } }
    end
  ...
  test "should update locale" do
    patch locale_url(@locale), params: { locale: { address: @locale.address, latitude: @locale.latitude, longitude: @locale.longitude } }
